...
const Card = (props) => {
  ...
  return (
     <div className={`lg:col-span-2 fixed  top-0 bg-[#1F1D2B] w-full h-full lg:w-[360px] lg:right-0 transition-all z-50 ${showOrder ? "right-0" : "-right-full"} `}>
          {/* Orders */}
          <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full ">
            ...
            <div>
              ...
              {/* Products*/}
              <div className="h-[300px] md:h-[700px] lg:h-[540px]">
                {/* Product*/}
